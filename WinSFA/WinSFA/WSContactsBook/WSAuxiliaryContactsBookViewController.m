//
//  WSAuxiliaryContactsBookViewController.m
//  WinSFA
//
//  Created by yuanji on 2018/5/3.
//  Copyright © 2018年 WinChannel. All rights reserved.
//

#import "WSAuxiliaryContactsBookViewController.h"
...
#pragma mark - 辅助通讯录视图管理器 延展(内部)
@interface WSAuxiliaryContactsBookViewController ()
...
#pragma mark - 辅助通讯录视图管理器 延展(工具)
@interface WSAuxiliaryContactsBookViewController (Tools)

#pragma mark - 普通初始化方法
- (void)commonInit;

#pragma mark - 布局辅助通讯录视图方法
- (void)layoutAuxiliaryContactsBookView;

@end
//===================================================================================================================================================================

#pragma mark - 辅助通讯录视图管理器 延展(实现UITableViewDelegate代理协议, 实现UITableViewDataSource数据源协议)
@interface WSAuxiliaryContactsBookViewController (tableViewDelegateAndDataSource) <UITableViewDelegate, UITableViewDataSource>

@end
//===================================================================================================================================================================

#pragma mark - 辅助通讯录视图管理器 延展(实现WSContactsBookHeaderViewDelegate代理协议)
@interface WSAuxiliaryContactsBookViewController (contactsBookHeaderViewDelegate) <WSContactsBookHeaderViewDelegate>

@end
//===================================================================================================================================================================

#pragma mark - 辅助通讯录视图管理器 延展(实现WSContactsBookSearchViewDelegate代理协议)
@interface WSAuxiliaryContactsBookViewController (contactsBookSearchViewDelegate) <WSContactsBookSearchViewDelegate>

@end
//===================================================================================================================================================================

#pragma mark - 辅助通讯录视图管理器
@implementation WSAuxiliaryContactsBookViewController
...
- (void)viewWillLayoutSubviews
{
    ...
    [self layoutAuxiliaryContactsBookView];
}
...
#pragma mark - 辅助通讯录视图管理器 延展(工具)
@implementation WSAuxiliaryContactsBookViewController (Tools)
...
- (void)commonInit
{
    ...
    self.nameIndexArray = [[NSMutableArray alloc] initWithArray:[WSContactsBookTools sharedManager].auxiliaryNameIndexArray];
    self.nameSectionDictionary = [[NSMutableDictionary alloc] initWithDictionary:[WSContactsBookTools sharedManager].auxiliaryNameSectionDictionary];
    ...
    [self.headerView updateWithIsShowOrganize:NO isShowAuxiliaryButton:NO];
...
- (void)layoutAuxiliaryContactsBookView
{
    ...
    CGFloat h = [self.headerView getHeightWithisShowOrganize:NO isShowAuxiliaryButton:NO maxWidth:CGRectGetWidth(self.view.frame)];
...
#pragma mark - 辅助通讯录视图管理器 延展(实现UITableViewDelegate代理协议, 实现UITableViewDataSource数据源协议)
@implementation WSAuxiliaryContactsBookViewController (tableViewDelegateAndDataSource)
...
#pragma mark - 辅助通讯录视图管理器 延展(实现WSContactsBookHeaderViewDelegate代理协议)
@implementation WSAuxiliaryContactsBookViewController (contactsBookHeaderViewDelegate)
...
#pragma mark - 辅助通讯录视图管理器 延展(实现WSContactsBookSearchViewDelegate代理协议)
@implementation WSAuxiliaryContactsBookViewController (contactsBookSearchViewDelegate)
