...
typedef enum {
    ...
    SDCycleScrollViewPageContolStyleCustom          // 自定义样式
...
/** 每张图片对应要显示的文字前面的小图标数组 */
@property (nonatomic, strong) NSArray *frontImageNameGroup;

/** 每张图片对应要显示的文字前面的小图标数组 */
@property (nonatomic, strong) UIColor *titleLabelAndFrontImageLineViewColor;
