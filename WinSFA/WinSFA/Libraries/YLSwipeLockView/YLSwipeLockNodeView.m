...
{
    self.outlineLayer.strokeColor =[UIColor colorFromHexCode:@"ff5929"].CGColor; //[UIColor whiteColor].CGColor;
    self.innerCircleLayer.fillColor = [UIColor clearColor].CGColor;
}

-(void)setStatusToSelected
{
    self.outlineLayer.strokeColor = [UIColor colorFromHexCode:@"ff5929"].CGColor;//LIGHTBLUE.CGColor;
    self.innerCircleLayer.fillColor = [UIColor colorFromHexCode:@"ff5929"].CGColor;//LIGHTBLUE.CGColor;
}
...
-(CAShapeLayer *)outlineLayer
{
    if (_outlineLayer == nil) {
        ...
        _outlineLayer.strokeColor = [UIColor colorFromHexCode:@"ff5929"].CGColor;//LIGHTBLUE.CGColor;
...
-(CAShapeLayer *)innerCircleLayer
{
    if (_innerCircleLayer == nil) {
        ...
        _innerCircleLayer.fillColor  = [UIColor colorFromHexCode:@"ff5929"].CGColor;//LIGHTBLUE.CGColor;
    }
