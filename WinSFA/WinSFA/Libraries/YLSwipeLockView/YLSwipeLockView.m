...
-(void)cleanNodes
{
    ...
    self.polygonalLineLayer.strokeColor = [UIColor colorFromHexCode:@"ff5929"].CGColor; //LIGHTBLUE.CGColor;
    self.polygonalLineLayer.path = self.polygonalLinePath.CGPath;
}
...
-(CAShapeLayer *)polygonalLineLayer
{
    if (_polygonalLineLayer == nil) {
        ...
        _polygonalLineLayer.strokeColor = [UIColor colorFromHexCode:@"ff5929"].CGColor;//LIGHTBLUE.CGColor;
