...
- (UIImage*)rotateImageWithSelfOritation
{
	return [self resizedImage:self.size interpolationQuality:kCGInterpolationDefault];
}
...
- (NSData*)rotatedRawData
{
	...
	CGBitmapInfo bitmapInfo = kCGBitmapAlphaInfoMask;//!!!!CGImageAlphaInfo alphaInfo = kCGImageAlphaPremultipliedFirst;
	...
	CGContextRef bitmap = CGBitmapContextCreate (pixelData, width, height, bitsPerComponent, width * bytesPerPixel, colorSpace, bitmapInfo);//alphaInfo);
