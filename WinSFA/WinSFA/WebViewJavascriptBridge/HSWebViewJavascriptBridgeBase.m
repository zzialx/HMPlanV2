//
//  HSWebViewJavascriptBridgeBase.m
//  WebBridgePlugin
//
//  Created by zhangjikuan on 2019/10/17.
//

#define BRIDGE_USE_TO_WC


#import "HSWebViewJavascriptBridgeBase.h"
#import "WebViewJavascriptBridge_JS.h"

@implementation HSWebViewJavascriptBridgeBase
{
...
- (void)injectJavascriptFile {
    // 此处js代码还是取原来的脚本，和H5端适配
    // 如果使用最新的脚本需要H5端做修改
#ifdef BRIDGE_USE_TO_WC
    NSBundle *bundle = [NSBundle mainBundle];
    NSString *filePath = [bundle pathForResource:@"WebViewJavascriptBridgeNew.js" ofType:@"txt"];
