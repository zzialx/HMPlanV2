...
@implementation WSReasonViewController
...
- (void)viewDidLoad
{
    ...
    UITableView* tv =[[UITableView alloc]initWithFrame:CGRectMake(0, 0, 320, 220) style:UITableViewStyleGrouped];
    tv.delegate = self;
    tv.dataSource = self;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    WSDictBean* db = (WSDictBean*)[self.myArray objectAtIndex:indexPath.row];
