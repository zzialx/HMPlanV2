...
#import "WSDisplayCheckViewController.h"
...
@implementation WSDisplayCheckViewController
...
- (void)loadView
{
    ...
    UITableView* tv = [[UITableView alloc]initWithFrame:CGRectMake(0, self.y_point+10, 320, 480-20-44-self.y_point) style:UITableViewStyleGrouped];
    tv.delegate = self;
    tv.dataSource = self;
