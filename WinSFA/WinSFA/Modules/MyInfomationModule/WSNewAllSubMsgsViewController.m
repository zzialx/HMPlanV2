...
@interface WSNewAllSubMsgsViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong)UITableView *iTableView;

@end

@implementation WSNewAllSubMsgsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (submsg.url && [submsg.url length] > 0) {
        /*
        cell.imageURLString = [self buildupUrl:submsg.url ] ;
        [cell.msg_imageView sd_setImageWithURL:[NSURL URLWithString:cell.imageURLString] placeholderImage:[UIImage imageForName:@"place_holder"]];
         */
    ...
    [cell.navButton setTitle:submsg.categoryTitle forState:UIControlStateNormal];
    [cell.navButton setTitle:submsg.categoryTitle forState:UIControlStateSelected];
