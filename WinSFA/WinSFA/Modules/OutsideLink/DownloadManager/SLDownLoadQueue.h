...
@property (nonatomic, strong) NSMutableArray  *downLoadQueueArr;  //装载非下载完成状态的model
@property (nonatomic, strong) NSMutableArray  *completedDownLoadQueueArr;  //装载已经下载完成的model
@property (nonatomic , assign) BOOL isAllPause;

@property (nonatomic,copy) void (^downLoadCount)(NSMutableArray *,NSMutableArray *);
