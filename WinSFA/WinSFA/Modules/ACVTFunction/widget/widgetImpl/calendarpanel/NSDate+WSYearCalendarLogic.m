...
@implementation NSDate (WSYearCalendarLogic)
...
- (NSUInteger)numberOfWeeksInCurrentMonth {
    ...
    NSUInteger days = [self numberOfWeeksInCurrentMonth];
    NSUInteger weeks = 0;
...
- (NSDate *)firstDayOfCurrentMonth {
    ...
    NSAssert1(ok, @"Failed to calculate the first day of the month base on %@", self);
    return startDate;
}
