...
- (void)viewDidLoad
{
    ...
    if(_maximumNumberOfSelection >1)
        self.labelSelectedMedia.text = NSLocalizedString(@"pls_select_photo", nil);
    else
        self.labelSelectedMedia.text = NSLocalizedString(@"pls_select_one_photo", nil);
...
- (void)setupCollectionView
{
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0  ,64  ,frame.size.width,frame.size.height - 64 -48)
                                             collectionViewLayout:layout];
//    if (UIInterfaceOrientationIsLandscape(orientation)) {
//        self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64, frame.size.height, frame.size.width - 64 -48)
//                                                 collectionViewLayout:layout];
//    }
//    else{
//        self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0  ,64  ,frame.size.width,frame.size.height - 64 -48)
...
- (void)setupGroup:(voidBlock)endblock withSetupAsset:(BOOL)doSetupAsset
{
    ...
    ALAssetsLibraryAccessFailureBlock failureBlock = ^(NSError *error) {
        ...
        [self setTitle:NSLocalizedString(@"Not Allowed",nil)];
//        [self.btnTitle setTitle:NSLocalizedStringFromTable(@"Not Allowed", @"UzysAssetsPickerController",nil) forState:UIControlStateNormal];
    ...
    [self.assetsLibrary enumerateGroupsWithTypes:ALAssetsGroupAll | ALAssetsGroupLibrary
...
- (void)showNoAssetsIfNeeded
{
    ...
    voidBlock setNoImage = ^{
        ...
        msg.text = NSLocalizedString(@"You can sync photos onto your iPhone using iTunes.", nil);
    };
    voidBlock setNoVideo = ^{
        ...
        UILabel *msg = (UILabel *)[weakSelf.noAssetView viewWithTag:kTagNoAssetViewMsgLabel];
        msg.text = NSLocalizedString(@"You can sync videos onto your iPhone using iTunes.", nil);
    ...
    if(self.assets.count ==0)
    {
        ...
        else
        {
            if(self.maximumNumberOfSelectionMedia >0)
            {
                ...
                msg.text = NSLocalizedString(@"You can sync media onto your iPhone using iTunes.", nil);
...
- (void)setTitle:(NSString *)title
{
    ...
    [self.btnTitle.titleLabel setFont:[UIFont systemFontOfSize:17]];
...
- (void) willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    float collviewWidth = viewBounds.size.width;
    float collviewHeight = collviewWidth * 4 / 3;
    if (collviewHeight > viewBounds.size.height) {
        collviewHeight = viewBounds.size.height;
    }
    self.collectionView.frame = CGRectMake(0, 64, collviewWidth, collviewHeight);
