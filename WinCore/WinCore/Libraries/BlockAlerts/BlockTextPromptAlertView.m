...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    CGFloat animationDuration = kAnimDuration;
    ...
    if(notification) {
        ...
        if(UIInterfaceOrientationIsPortrait(orientation) || !IOS_LESS_THAN_7)
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    if (frame.origin.y == screenHeight - keyboardHeight - frame.size.height - 10 && self.originY) {
