...
- (CGSize)ws_sizeWithFont:(UIFont *)font constrainedToWidth:(CGFloat)width {
    return [self ws_sizeWithFont:font constrainedToWidth:width lineBreakMode:NSLineBreakByWordWrapping];
}
...
- (CGSize)ws_sizeWithFont:(UIFont *)font constrainedToHeight:(CGFloat)height {
    return [self ws_sizeWithFont:font constrainedToHeight:height lineBreakMode:NSLineBreakByWordWrapping];
}
...
- (CGFloat)ws_sizeWithFont:(UIFont *)font constrainedToWidth:(CGFloat)width margin:(CGFloat)margin{
    return  [self ws_sizeWithFont:font constrainedToWidth:width margin:margin lineBreakMode:NSLineBreakByWordWrapping];
}
...
- (CGFloat)ws_sizeWithFont:(UIFont *)font constrainedToWidth:(CGFloat)width margin:(CGFloat)margin lineBreakMode:(NSLineBreakMode)lineBreakMode{
    ...
    NSDictionary *attributes = @{NSFontAttributeName: font,
                                 NSParagraphStyleAttributeName: paragraph};
    textSize = [self boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, width)
                                  options:(NSStringDrawingUsesLineFragmentOrigin |
                                           NSStringDrawingTruncatesLastVisibleLine)
                               attributes:attributes
                                  context:nil].size;
